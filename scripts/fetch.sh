...
METAPYTHONTEST_URI="."
METAPYTHONTEST_PATH="poky/meta-python-test"
...
rm -rf "${METAPYTHONTEST_PATH}" || die "unable to clear old ${METAPYTHONTEST_PATH}"
ln -sf "../${METAPYTHONTEST_URI}" "${METAPYTHONTEST_PATH}" || \
	die "unable to symlink ${METAPYTHONTEST_PATH}"
